    ...
    <div className="bg-[#FAF8F5] min-h-screen text-[#231F20] overflow-x-hidden font-sans">
      ...
      <section className="py-6 sm:py-9 bg-white border-b border-[#EAE4DC]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* 4 Beautiful Gift Box Cards with Grand Ribbon Packaging (All 4 in ONE Row on Mobile & PC) */}
          <div className="grid grid-cols-4 gap-2 sm:gap-4 md:gap-6 pt-4 sm:pt-6">
            ...
            >
              {/* Small Velvet Ribbon Bow on Mobile & Grand on PC */}
              <div className="absolute -top-3 sm:-top-5 left-1/2 -translate-x-1/2 z-20 pointer-events-none transition-transform duration-300 group-hover:scale-110 drop-shadow-sm sm:drop-shadow-md">
                <svg className="w-10 sm:w-20 h-4 sm:h-8 block" viewBox="0 0 80 32" fill="none">
                  {/* Left & Right Loop Shadows */}
                  <path d="M40 16 C26 2, 8 4, 10 16 C12 24, 30 20, 40 16 Z" fill="#590D1E" />
                  <path d="M40 16 C54 2, 72 4, 70 16 C68 24, 50 20, 40 16 Z" fill="#590D1E" />
                  {/* Satin Body Loops */}
                  <path d="M40 16 C27 4, 11 6, 13 16 C15 22, 32 19, 40 16 Z" fill="#7A152E" />
                  <path d="M40 16 C53 4, 69 6, 67 16 C65 22, 48 19, 40 16 Z" fill="#7A152E" />
                  {/* Satin Highlight Sheen Strokes */}
                  <path d="M38 14 C28 6, 16 8, 14 15" stroke="#E2738E" strokeWidth="1.2" strokeLinecap="round" opacity="0.75" fill="none" />
                  <path d="M42 14 C52 6, 64 8, 66 15" stroke="#E2738E" strokeWidth="1.2" strokeLinecap="round" opacity="0.75" fill="none" />
                  {/* Cascading Fishtail Streamers */}
                  <path d="M37 17 L20 31 L29 22 Z" fill="#8B1D35" />
                  <path d="M37 17 L20 31 L24 29 Z" fill="#590D1E" />
                  <path d="M43 17 L60 31 L51 22 Z" fill="#8B1D35" />
                  <path d="M43 17 L60 31 L56 29 Z" fill="#590D1E" />
                  {/* Center Gold Knot Medallion */}
                  <circle cx="40" cy="16" r="4.5" fill="#D4AF37" stroke="#7A152E" strokeWidth="0.8" />
                  <circle cx="40" cy="16" r="3" fill="#7A152E" />
                  <circle cx="39" cy="15" r="0.9" fill="#FFFFFF" fillOpacity="0.9" />
                </svg>
              </div>
              ...
              <div className="absolute inset-0 rounded-2xl sm:rounded-3xl overflow-hidden pointer-events-none z-0">
                ...
                <div className="absolute inset-y-0 left-1/2 -translate-x-1/2 w-5 sm:w-8 bg-gradient-to-r from-[#6A0E22]/15 via-[#8B1D35]/25 to-[#6A0E22]/15 border-x border-[#D4AF37]/45 shadow-xs" />
                ...
                <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-3 sm:h-6 bg-gradient-to-b from-[#6A0E22]/12 via-[#8B1D35]/20 to-[#6A0E22]/12 border-y border-[#D4AF37]/40 shadow-xs" />
                ...
                <div className="absolute inset-1.5 sm:inset-3 rounded-xl sm:rounded-2xl border border-dashed border-[#CBA64E]/40 group-hover:border-[#CBA64E]/75 transition-colors" />
              ...
              <div className="relative z-10 flex flex-col items-center justify-center py-1 sm:py-2 px-1 sm:px-3 rounded-xl backdrop-blur-[2px] bg-white/75 sm:bg-white/85 border border-white/60 shadow-2xs group-hover:bg-white/95 transition-all">
                <span className="font-sans text-[8.5px] sm:text-[11px] uppercase font-bold text-stone-600 sm:text-[#8C6D3B] tracking-wider sm:tracking-widest block">
                  UNDER
                </span>
                <span className="font-serif font-bold text-sm sm:text-2xl md:text-3xl text-[#7A152E] tracking-tight block mt-0.5 group-hover:scale-105 transition-transform">
                  ₹999
                </span>
                <span className="text-[7.5px] sm:text-xs text-stone-600 group-hover:text-[#7A152E] font-medium tracking-wide block mt-0.5 sm:mt-1 transition-colors truncate max-w-full">
                  Daily Picks
                </span>
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center justify-center py-1 sm:py-2 px-1 sm:px-3 rounded-xl backdrop-blur-[2px] bg-white/75 sm:bg-white/85 border border-white/60 shadow-2xs group-hover:bg-white/95 transition-all">
                ...
                <span className="font-serif font-bold text-xs sm:text-xl md:text-2xl text-[#7A152E] tracking-tight block mt-0.5 group-hover:scale-105 transition-transform leading-snug">
                  GIFTS
                </span>
                <span className="text-[7.5px] sm:text-xs text-stone-600 group-hover:text-[#7A152E] font-medium tracking-wide block mt-0.5 sm:mt-1 transition-colors truncate max-w-full">
                  Vault Sets
